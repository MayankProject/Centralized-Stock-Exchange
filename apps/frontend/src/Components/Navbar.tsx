    ...
    return (
        <nav className="border-b flex justify-between border-gray-800 py-3 px-10" >
            <div className="flex gap-5 items-center" >
                ...
                < div className="text-[#02a166] amount text-2xl" >
                    $200
                </div>
            </div>
            <div className="relative">
                ...
                rgba(0, 0, 0, 0.09) 0px -3px 5px`,
                    ...
                    {
                        Object.entries(allUsers).filter((user) => user[0] !== currentUser.id).map((user) => < div className="avatar cursor-pointer my-1 flex gap-4 justify-between items-center text-white bg-[#202127] py-2 px-5 rounded-xl" onClick={() => { changeUser(user[0]) }}>
                            <div>
